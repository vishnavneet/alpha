      ...
      <div className="grid grid-cols-2">
                ...
                usersData.map((el, i) => {
                  return (
                    <tr key={"key" + (i + 1)}>
                      ...
                      <td>
                        <button
                          onClick={EditTableRow(el.id, el.name, el.email)}
                        >
                          <svg
        ...
        <div>
          <form className="max-w-md mx-auto" onSubmit={handleSubmitUser}>
            ...
            <div className="block">
              <button
                className="bg-blue-500 w-100 block hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline"
                type="submit"
              >
                Submit
              </button>
